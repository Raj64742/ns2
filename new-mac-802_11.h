/* -*- c++ -*-
   ...
   */
#ifndef ns_new_mac_80211_h
#define ns_new_mac_80211_h
...
/* ======================================================================
   ...
   ====================================================================== */
class newMac802_11 : public newMac {
...
public:
	newMac802_11(PHY_MIB* p, MAC_MIB *m);
...
private:
	...
	inline int initialized() {
		return (phymib_ && macmib_ && cache_ && logtarget_ && newMac::initialized());
	}
...
private:
	...
	newMacState	rx_state_;	// incoming state (MAC_RECV or MAC_IDLE)
	newMacState	tx_state_;	// outgoint state
#if 1
