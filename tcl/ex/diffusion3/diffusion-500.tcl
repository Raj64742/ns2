...
set opt(nn)		500	;# number of nodes
set opt(seed)		0.0
set opt(stop)		500	;# simulation time
set opt(prestop)        499       ;# time to prepare to stop
set opt(tr)		"diffusion500.tr"	;# trace file
set opt(nam)            "diffusion500.nam"  ;# nam file
set opt(adhocRouting)   Directed_Diffusion
set opt(traf)		"diffusion-traf500.tcl"      ;# traffic file
set opt(move)           "scen-500-test"    ;#node movement file
# ==================================================================
