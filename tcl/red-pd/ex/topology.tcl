...
Topology/netTestFRp instproc init ns {
    ...
    $ns duplex-link $node_(s0) $node_(r0) 1000Mb 80ms DropTail
    $ns duplex-link $node_(s1) $node_(r0) 1000Mb 40ms DropTail
    $ns duplex-link $node_(s2) $node_(r0) 1000Mb 26.7ms DropTail
    $ns duplex-link $node_(s3) $node_(r0) 1000Mb 20ms DropTail
    $ns duplex-link $node_(s4) $node_(r0) 1000Mb 10ms DropTail
    $ns duplex-link $node_(s5) $node_(r0) 1000Mb 5ms DropTail
    ...
    $redpdq_ set P_testFRp_ 0.05
}

Class Topology/netTestIdent -superclass Topology
Topology/netTestIdent instproc init ns {
    $self next $ns 5 2
    $self instvar node_ redpdq_ redpdflowmon_ redpdlink_
