...
# need catch for those "warning: no class variable Queue/RED::fracminthresh_"
    catch {exec ../../ns Collapse.v2.tcl simple 0.000$i $bandwidth} result
#    puts stderr $result
...
for {set i 1} {$i <= 9} {incr i 1} {
    ...
    catch {exec ../../ns Collapse.v2.tcl simple 0.00$i $bandwidth} result
#    puts stderr $result
    append $infile $datafile
}
...
for {set i 1} {$i <= 9} {incr i 1} {
    ...
    catch {exec ../../ns Collapse.v2.tcl simple 0.0$i $bandwidth} result
#    puts stderr $result
    append $infile $datafile
}
finish
