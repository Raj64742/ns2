...
Topology/net3 instproc init ns {
	...
	$ns duplex-link $node_(s5) $node_(r1) 10Mb 2ms DropTail
...
Test/one instproc traffic1 {} {
    $self instvar node_ 
    $self new_tcp 7.0  $node_(s1) $node_(s3) 50 1 0 1500 sack 0
    $self new_tcp 4.2 $node_(s2) $node_(s4) 50 2 0 1500 sack 0
    $self new_cbr 1.4 $node_(s1) $node_(s4) 200 0.003 3 0
    $self new_tcp 9.4 $node_(s1) $node_(s4) 50 4 0 1500 sack 0
...
#    set stoptime 200.0
	...
	$self linkDumpFlows $L1 5.0 $stoptime
