...
// $Id: hashutils.cc,v 1.6 2002/04/02 23:58:39 haldar Exp $
//
 ...
 *
 * RCS: @(#) $Id: hashutils.cc,v 1.6 2002/04/02 23:58:39 haldar Exp $
 */
...
static Tcl_HashEntry *
StringCreate(Tcl_HashTable *tablePtr, CONST char *key, int *newPtr)
/*
*    Tcl_HashTable *tablePtr;	* Table in which to lookup entry.
...
static Tcl_HashEntry *
OneWordFind(Tcl_HashTable *tablePtr, register CONST char *key)
/*
*    Tcl_HashTable *tablePtr;	* Table in which to lookup entry.
...
static Tcl_HashEntry *
OneWordCreate(Tcl_HashTable *tablePtr, register CONST char *key, int *newPtr)
/*
*    Tcl_HashTable *tablePtr;	* Table in which to lookup entry.
...
static Tcl_HashEntry *
ArrayFind(Tcl_HashTable *tablePtr, CONST char *key)
/*
*    Tcl_HashTable *tablePtr;	* Table in which to lookup entry.
*    CONST char *key;		* Key to use to find matching entry.
*/
...
static Tcl_HashEntry *
ArrayCreate(Tcl_HashTable *tablePtr, register CONST char *key, int *newPtr)
/*
*    Tcl_HashTable *tablePtr;	* Table in which to lookup entry.
*    register CONST char *key;	* Key to use to find or create matching
*				* entry.
 ...
 */
	...
	/* ARGSUSED */
static Tcl_HashEntry *
BogusFind(Tcl_HashTable *tablePtr, CONST char *key)
/*
*    Tcl_HashTable *tablePtr;	* Table in which to lookup entry.
*    CONST char *key;		* Key to use to find matching entry.
*/
{
  diffPrint(DEBUG_ALWAYS, "called Tcl_FindHashEntry on deleted table\n");
  abort();
 ...
 */
	...
	/* ARGSUSED */
static Tcl_HashEntry *
BogusCreate(Tcl_HashTable *tablePtr, CONST char *key, int *newPtr)
/*
*    Tcl_HashTable *tablePtr;	* Table in which to lookup entry.
*    CONST char *key;		* Key to use to find or create matching
*				* entry.
...
*/
{
  diffPrint(DEBUG_ALWAYS, "called Tcl_CreateHashEntry on deleted table\n");
  abort();
