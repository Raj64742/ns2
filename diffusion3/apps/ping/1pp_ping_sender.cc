...
// $Id: 1pp_ping_sender.cc,v 1.1 2004/01/08 22:56:39 haldar Exp $
//
...
void OPPPingSendDataTimer::expire(Event *e) {
  a_->send();
}
...
void OPPPingSenderApp::recv(NRAttrVec *data, NR::handle my_handle)
{
