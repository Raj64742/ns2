...
%        - KFALL
%
\chapter{\shdr{Trace and Monitoring Support}{trace.h}{sec:trace}}
...
\section{\shdr{Trace Support}{ns-lib.tcl}{sec:otcltrace}}
...
\subsection{\shdr{otcl helper functions}{ns-lib.tcl}{sec:helptrace}}
...
\section{\shdr{Library support and examples}{ns-lib.tcl}{sec:libexam}}
...
\section{\shdr{The C++ Trace Class}{trace.cc}{sec:tracemoncplus}}
...
\section{\shdr{trace file format}{trace.cc}{sec:traceformat}}
...
\section{\shdr{packet types}{trace.h}{sec:traceptype}}
...
\section{\shdr{Queue Monitoring}{queue-monitor.cc}{sec:qmonitor}}
...
\section{\shdr{Per-Flow Monitoring}{flowmon.cc}{sec:flowmon}}
...
\subsection{\shdr{the flow monitor}{flowmon.cc}{sec:flowclass}}
...
\subsection{\shdr{flow monitor trace format}{flowmon.cc}{sec:flowmonclass}}
...
\subsection{\shdr{the flow class}{flowmon.cc}{sec:flowclass}}
