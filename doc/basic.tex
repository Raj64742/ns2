...
{\cf # Some agents.}
set cbr0 [new Agent/CBR]		\; A source agent;
$ns attach-agent $n0 $cbr0		\; on node $n0;
$cbr0 set class_ 0			\; actually, the default, but\ldots;
...
set ftp [new Source/FTP]	\; TCP does not generate its own traffic;
$ftp set agent_ $tcp
$ns at 1.2 "$ftp start"
...
{\cf # This procedure closes all trace files, and invokes nam visualisation on one of the trace files.}
