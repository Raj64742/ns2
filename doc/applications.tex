...
is used in TCP agents.  In TCP, \code{done} is called when a TCP sender has 
received ACKs for all of its data and is now closed.  The \code{done\{\}}
...
object are:
\begin{alist}
\code{packet\_size\_} & the constant size of the packets generated\\
