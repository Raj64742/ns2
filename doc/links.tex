...
\code{$simplelink attach-monitors <insnoop> <outsnoop> <dropsnoop>
<qmon>}\\
...
\code{$ns_ duplex-intserv-link <n1> <n2> <bw> <dly> <sched> <signal>
<adc> <args>}\\
...
link.  Like, \code{$link all-connectors reset} or \code{$link
all-connectors isDynamic}. 
