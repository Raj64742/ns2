...
\begin{flushleft}
\code{$ns_ satnode-polar <alt> <inc> <lon> <alpha> <plane> <linkargs>
<chan>}\\
...
<inc> is orbit inclination w.r.t equator, <lon> is the longitude, <alpha>
gives the initial position of the satellite, <plane> defines the plane of
...
This is a method that creates a satellite of the type <type> which maybe
polar, geo or terminal. 
...
\code{$satnode add-gsl <ltype> <opt_ll> <opt_ifq> <opt_qlim> <opt_mac> 
