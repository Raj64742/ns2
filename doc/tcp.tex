\chapter{\shdr{TCP Agents}{tcp.cc}{sec:tcp}}
...
\section{\shdr{One-Way TCP Senders}{tcp.h}{sec:tcp}}
...
\subsection{\shdr{the base TCP sender (Tahoe TCP)}{tcp.cc}{sec:tahoetcp}}
...
\section{\shdr{Two-Way TCP Agents (FullTcp)}{tcp.h}{sec:fulltcp}}
\label{sec:fulltcp}
...
\section{\shdr{Tracing TCP Dynamics}{tcp.cc}{sec:tcpdyn}}
...
\section{\shdr{One-Way Trace TCP Trace Dynamics}{tcp.cc}{sec:tcpdyn}}
...
statistical summaries (see,  for example, {\tt test-suite.tcl}, the
{\tt finish} procedure.
