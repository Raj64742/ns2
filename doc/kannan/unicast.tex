...
\subsubsection{Other Configuration Mechanisms for Specialised Routing}
...
\subsubsection{Protocol Specific Configuration Parameters}
...
In this subsection, we will briefly describe the interface for the basic
procedures.
...
\subsubsection{Interface to Network Dynamics and Multicast}
\label{sec:rtglibAPI}
...
\proc[]{rtObject::intf-changed} invokes \proc[]{rtObject::compute-routes}
