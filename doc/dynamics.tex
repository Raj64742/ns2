...
\href{the deficiencies in the current realisation}{Section}{sec:deficiencies}
...
dervied from the base \clsref{rtModel}{../ns-2/dynamics.tcl}.
We begin by describing
\href{the base class rtModel and the derived classes}{Section}{sec:rtmodel}.
The network dynamics models use an internal queueing structure
...
\item The 
  ...
  It also initialises the \code{startTime_} and \code{finishTime_}
...
\item % trace
  ...
  \proc[]{trace-dynamics} is discussed in the
...
The instance procedure \proc[]{Simulator::run} invokes
...
and then invokes \proc[]{configur} for each route model in its list,
\code{rtModel_}.
\begin{list}{}{}
\item The instance procedure
...
\subsection{\clsref{rtQueue}{../ns-2/dynamics.tcl}}
\label{sec:rtqueue}
...
in the \clsref{Simulator}{../ns-2/ns-lib.tcl}:
\proc[]{rtmodel}, \proc[]{rtmodel-at}, \proc[]{rtmodel-delete}, and
\proc[]{rtmodel-configure} \href{in earlier sections}{Section}{sec:XXX}.
...
\paragraph{\clsref{DynamicLink}{../ns-2/dynalink.cc.tcl}}
...
\paragraph{\clsref{Link}{../ns-2/ns-link.tcl}}
...
\paragraph{\clsref{SimpleLink}{../ns-2/ns-link.tcl}}
