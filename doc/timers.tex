...
%
\chapter{\shdr{Timers}{timer-handler.h}{chap:timers}}
...
\begin{program}
        /*
         *{\cf Set retransmit timer using current rtt estimate.  By calling \fcn[]{sched}}
