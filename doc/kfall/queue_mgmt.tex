...
The \code{drop\_} member variable contains a pointer to the object
...
passing \code{\&qh\_} to the simulator scheduler.
...
\subsubsection{\shdr{OTcl members}{../ns/ns-lib.tcl}{sec:qtclmembers}}

A Queue object has one method available from OTcl
called \code{drop-target}.
...
The \code{length} and \code{bcount} functions return these values,
respectively.
