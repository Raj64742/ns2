...
functionality into three components: \code{LL} (link-layer),
...
When a \code{Mac} object receivs a packet via its \code{recv()} method,
...
wireless networks, one can use the \code{ErrorModel} described in 
