...
\href{in the common packet header}{Section}{sec:pformat}:
...
\href{used by the packet tracing facility}{Section}{sec:trace}
and are defined in \nsf{trace.h}.
...
\href{class Source/FTP}{Section}{sec:sources}.
...
As described in 
\href{the following section}{Section}{sec:timers}, specific
