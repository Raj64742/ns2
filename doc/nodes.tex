...
\proc[]{Simulator::node-config} accomodates flexible and modular
...
simply say \proc[]{node-config -adhocRouting dsdv}.
...
\framebox{
  \begin{minipage}{\textwidth}
    ...
    in the old format, namely, nodes built using inheritance. In
    particular, satellite simulation and part of mobile IP are not
    covered. 
    [Sep 15, 2000].
  \end{minipage}
}
