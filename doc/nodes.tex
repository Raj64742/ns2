...
Following is a list of internal node methods that may be used for
changes/modification of the core code:
...
There are other specific node commands that supports hierarchical routing, PIM, IntTCP,
detailed dynamic routing, equal cost multipath routing, PGM router, manual
routing and power model for mobilenodes. These and other methods described
earlier can be found in \ns/tcl/lib/ns-node.tcl.
